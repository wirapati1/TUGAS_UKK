...
<head>
    ...
    <title>Halaman Detail Pembelian</title>
    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div class="col py-3 mt-5 mx-5">
                ...
                <h3 class="text-white mb-4">Detail Pembelian</h3>
                <div class="mb-3">

                    <a type="button" href="data_pelanggan.php" class="btn btn-danger">Kembali</a>
                </div>
