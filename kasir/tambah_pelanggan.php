    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div class="col py-3 ">
                ...
                <form action="aksi/tambah_pelanggan.php" method="post"   class="  col-6 justify-content-center mx-auto mt-5 ">
                    <div>
                        <img src="assets/pelanggan.webp" width="30%" class="d-block mx-auto mb-3" alt="">
                        <h2 class="text-white text-center">Tambah Pelanggan Sekarang !</h2>
                    </div>
                    <div class="mb-3 text-white">
                        <label for="NamaPelanggan" class="form-label">Nama Pelanggan</label>
                        <input required type="text" name="NamaPelanggan"
                    ...
                    <div class="mb-3 text-white">
                        ...
                        <input required type="number" name="NomorTelepon"
                            style="color: white; border: none; background-color: #1a2b32;" class="form-control"
                            id="NomorTelepon">
