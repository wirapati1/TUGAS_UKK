    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div class="col py-3 mt-5 mx-5">
                ...
                <form action="aksi/tambah_produk.php" method="post"
                    class="  col-6 justify-content-center mx-auto mt-5 ">
                    <div>
                        <img src="assets/produk.webp" width="30%" class="d-block mx-auto mb-3" alt="">
                        <h2 class="text-white text-center">Tambah Produk Sekarang !</h2>
                    </div>
                    <div class="mb-3 text-white">
                        <label for="NamaProduk" class="form-label">Nama Produk</label>
                        <input required type="text" name="NamaProduk"
                    ...
                    <div class="mb-3 text-white">
                        ...
                        <input required type="text" name="Harga"
                            style="color: white; border: none; background-color: #1a2b32;" class="form-control"
                            id="Harga">
                    ...
                    <div class="mb-3 text-white">
                        ...
                        <input required type="number" name="Stok"
                            style="color: white; border: none; background-color: #1a2b32;" class="form-control"
                            id="Stok">
